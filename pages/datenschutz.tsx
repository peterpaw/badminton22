  ...
  return (
    <Container size="sm" className="py-16">
      ...
      <Text>
        ...
        ist: <br />
        SV Rot-Weiss Walldorf e.V. <br />
        An den Sportpla?tzen 27 <br />
        Postfach 2333 <br />
      ...
      <Text>
        ...
        Rechtsbehelfe. Recht auf Datenübertragbarkeit Sie haben das Recht,
      ...
      <Text>
        ...
        widerrufbar. Soweit andere Cookies (z. B. Cookies zur Analyse Ihres
      ...
      <Text>
        ...
        insbesondere gesetzliche Aufbewahrungsfristen – bleiben unberührt. 4.
        Soziale Medien
      </Text>
      <Title order={4} className="text-left mb-4 mt-8">
        Google Web Fonts
      ...
      <Text>
        ...
        ansprechenden Darstellung unserer OnlineAngebote und an einer leichten
      ...
      <Text>
        Wir verwenden auf unserem Internetauftritt “Google (Invisible)
        reCAPTCHA”, einen Dienst der Google Ireland Limited, Google Building
        Gordon House, Barrow St, Dublin 4, Irland (nachfolgend bezeichnet als
        “Google”). Google (Invisible) reCAPTCHA verarbeitet Informationen über
        Ihr Nutzerverhalten auf unserem Internetauftritt. Wir verwenden Google
        (Invisible) reCAPTCHA zur Prüfung, ob die Eingabe durch einen Menschen
        oder missbräuchlich durch automatisierte, maschinelle Verarbeitung
        erfolgt. Das Verfahren dient damit der Abwehr von Spam, DDoS-Attacken
        und ähnlichen automatisierten Schadzugriffen. Der Einsatz von Google
        (Invisible) reCAPTCHA dient damit unmittelbar der Sicherstellung der
        Integrität und Funktionsfähigkeit unserer Systeme. Hierin liegt auch
        unser berechtigtes Interesse. Rechtsgrundlage ist Art. 6 Abs. 1 S. 1
        lit. f) DSGVO. Die im Rahmen von Google (Invisible) reCAPTCHA
        übermittelte IP-Adresse wird nicht mit anderen Daten von Google
        zusammengeführt, außer Sie sind zum Zeitpunkt der Nutzung von Google
        (Invisible) reCAPTCHA bei Ihrem Google-Account angemeldet. Wenn Sie
        diese Übermittlung und Speicherung von Daten über Sie und Ihr Verhalten
        auf unserer Webseite durch Google unterbinden wollen, müssen Sie sich
        bei Google ausloggen und zwar bevor Sie unsere Seite besuchen bzw.
        Google (Invisible) reCAPTCHA benutzen. Sie können der Erfassung und
        Weiterleitung personenbezogenen Daten widersprechen oder die
        ...
        https://www.ghostery.com). Wir weisen darauf hin, dass Sie in diesem
        Fall möglicherweise nicht alle Funktionen unseres Internetauftritts
        vollumfänglich nutzen können. Informationen des Drittanbieters: Google
        Ireland Limited, Google Building Gordon House, Barrow St, Dublin 4,
        Irland Weitere Informationen des Drittanbieters zum Datenschutz können
        Sie der nachfolgenden Webseite entnehmen:
